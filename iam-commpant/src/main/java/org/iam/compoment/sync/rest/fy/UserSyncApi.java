...
*/		
		contentMap.put("id", "100312333");
		contentMap.put("loginname", "testsync0021");
		contentMap.put("password", "123456");
		contentMap.put("name_path", "/盛煦集团/区域公司/北京城市公司/");
		contentMap.put("orgname", "运营部");
	...
	public ResultCode addUser(Map<String, String> map){
		...
		xml.append("</soapenv:Envelope>");
		String resp="";
		resp=HttpUtil.soapPostSendXml(address+"/services/HrmService", xml.toString());
