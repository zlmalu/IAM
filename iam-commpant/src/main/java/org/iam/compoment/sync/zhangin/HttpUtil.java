...
//		System.out.println(login_token);
		//获取部门信息
		//{"data_list":[{"is_enable":1,"name":"默认部门","id":"402881ec74c52a7b017545413714018e"}],"errcode":0,"errmsg":"请求成功"}
...
//		System.out.println(departmentInfo);
		//获取用户信息
		//{"data_list":[{"is_enable":1,"department_id":"402881ec74c52a7b017545413714018e","mobile":"15618956022","name":"接口测试","id":"402881ec74c52a7b017545413716018f","status":0}],"errcode":0,"errmsg":"请求成功"}
...
//		json.put("name", "申石测试");
//		json.put("code", "test001");
//		json.put("parent_id", "402881ec74c52a7b017545413714018e");
...
//		System.out.println(dep_result);
		//删除部门信息
//		String dep_result=HttpUtil.DELETES("http://test.zhangin.com:8896/api/department/batchDelete.htm?department_ids=8a808352753fdd2701754a93c2fd1c94,8a808352753fdd2701754a9f65141c96", headers);
//		System.out.println(dep_result);
		//批量添加人员信息
//		JSONArray jsons = new JSONArray();
//		JSONObject json = new JSONObject();
