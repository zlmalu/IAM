...
public class DESUtil {
	...
	public static String dataTime(Long totalMilliSeconds){
	...
	public static String dataTime2(Long totalMilliSeconds){
        Date nowTime = new Date(totalMilliSeconds);
	...
	/*public static void main(String[] args) throws Exception {
		String seed = "LOVEMOIVE"; // des加密时使用的key
		...
		String c = DESUtil.encrypt(seed, plainText); // 加密参数
		System.out.println("加密的链接："+c);
		String link = "http://localhost:8080/LoveMovie/forgetPassword/resetPassword?key=" + c;
