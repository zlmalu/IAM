...
public class BaseAction {
	...
	@SuppressWarnings("rawtypes")
	protected void exportXlsxSheet(String fileName,List contentList,List<ExcelUtils.ExcelModel> ems,String sheetName){
		this.exportXlsx(fileName, contentList, ems, sheetName);
	}
