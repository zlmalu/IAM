...
@RestController
@Controller
@RequestMapping("sys/portal/template")
@ApiSort(value = 9)
public class PortalTemplateAction extends AbstractAction<PortalTemplate,Long>{
	...
	public ResultCode save(@RequestBody PortalTemplate entity) {
	...
	public ResultCode edit(@RequestBody PortalTemplate entity) {
		if(entity.getId()==0){
	...
	@ResponseBody
	public PortalTemplate findById(@PathVariable Long id) {
	...
	protected PageList<PortalTemplate> findList(@RequestBody PortalTemplate entity1,@RequestParam(defaultValue="1") Integer page,@RequestParam(defaultValue="20") Integer limit){
		try{
			...
			return new PageList<PortalTemplate>();
		}
	}
