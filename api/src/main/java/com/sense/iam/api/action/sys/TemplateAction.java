...
import com.sense.iam.model.sys.Template;
...
@ApiSort(value = 31)
public class TemplateAction extends AbstractAction<Template,Long>{
	...
	public ResultCode save(@RequestBody Template entity) {
	...
	public ResultCode edit(@RequestBody Template entity) {
	...
	public Object findAll() {
		return super.findAll(new Template());
	}
	...
	protected PageList<Template> findList(@RequestBody Template entity1,@RequestParam(defaultValue="1") Integer page,@RequestParam(defaultValue="20") Integer limit){
		try{
